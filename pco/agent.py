...
Action Input: {{"llm_agent_id": "{llm_agent_id}", "code": "echo 'import datetime\\nprint(\\"Hello, Persistent Sandbox!\\")\\nprint(datetime.datetime.now())' > {shared_dir_path}/my_program.py && python {shared_dir_path}/my_program.py", "base_image": "python:3.10-slim-bookworm"}}
"""),
